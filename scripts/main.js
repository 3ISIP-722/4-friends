...
const allProducts = [
    ...
    { id: 22, name: 'выключатель', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Розетки и выключатели' },
    { id: 23, name: 'розетка', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Розетки и выключатели' },
    { id: 24, name: 'кабель', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Кабели и монтаж' },
    { id: 25, name: 'кабель', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Кабели и монтаж' },
    { id: 26, name: 'кабель', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Кабели и монтаж' },
    { id: 27, name: 'пластиковые окна', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Готовые окна' },
    { id: 28, name: 'пластиковые окна', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Готовые окна' },
    { id: 29, name: 'пластиковые окна', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Готовые окна' },
    { id: 30, name: 'сетка', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Москитные сетки' },
    { id: 31, name: 'сетка', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Москитные сетки' },
    { id: 32, name: 'сетка', price: 8500, image: 'https://via.placeholder.com/200x150?text=Окно+ПВХ', stock: true, category: 'Москитные сетки' },
];
